...
- [ ] If the PR title, body, or self-review notes were prepared with AI assistance, the PR text explicitly calls for human confirmation of scope, validation evidence, and merge risk before final submission or merge, and does not claim that confirmation already happened unless it actually did.
