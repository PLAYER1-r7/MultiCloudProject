...
- Issue 149 has now advanced beyond client-only groundwork into a locally runnable HTTP SNS service with service-owned file persistence and passing browser-side HTTP reachability plus auth-post-readback evidence; staging/cloud runtime rollout and rollback-reviewed completion remain pending in Issue 150 and Issue 151
